  ...
  return (
    <div className="flex items-center justify-between mid:w-[1102px] w-full pt-8">
      ...
      <section className="flex items-center mid:gap-7 gap-5">
        <button className="mid:text-[13px] mobile:text-[13px] xsmall:text-[8px] font-[700] leading-normal text-[#B5B5B5]">
          Cancel
        </button>
        <button className="mid:w-[147px] mid:h-[38px] mobile:w-[120px] mobile:h-[38px] xsmall:w-[80px] flex items-center justify-center xsmall:h-[30px] rounded-md bg-[#EB7421]">
